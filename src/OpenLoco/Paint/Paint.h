...
#pragma pack(push, 1)
    ...
    struct PaintStruct
    {
        ...
        union
        {
            loco_ptr2<Map::tile_element> tileElement; // 0x30 (or thing pointer)
            loco_ptr2<Thing> thing;                   // 0x30
        };
    };
...
#pragma pack(pop)
    ...
    public:
        ...
        Gfx::drawpixelinfo_t* getContext() { return _dpi->get(); }
    ...
    private:
        ...
        inline static Interop::loco_global<loco_ptr2<Gfx::drawpixelinfo_t>, 0x00E0C3E0> _dpi;
        ...
        inline static Interop::loco_global<loco_ptr2<void>, 0x00E4F0B4> _currentlyDrawnItem;
        ...
        inline static Interop::loco_global<loco_ptr2<void>, 0x00E3F0B4> _currentItem;
